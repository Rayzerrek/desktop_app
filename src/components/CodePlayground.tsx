                ...
                <div className="flex items-center gap-3">
                    <select
                        ...
                        onChange={(e) => {
                            ...
                            if (lang === "typescript") setCode('const msg: string = "Hello, World!";\nconsole.log(msg)');
                        }}
                    ...
                    >
                        ...
                        <option value="javascript">{getCourseIcon("javascript")} JavaScript</option>
                        <option value="typescript">{getCourseIcon("typescript")} TypeScript</option>
                    </select>
