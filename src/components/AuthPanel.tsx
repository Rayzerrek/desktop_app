...
export default function AuthPanel({ onLoginSuccess }: AuthPanelProps) {
  ...
  const handleGoogleLogin = async () => {
    setLoading(true)
    try {
      const authUrl = await invoke<string>('google_sign_in')
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4">
        <div
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white/80 dark:bg-slate-800/80 text-slate-500 dark:text-slate-400">Lub</span>
              </div>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
            {isLogin ? (
              <p>
                ...
                <button
                  onClick={() => setIsLogin(false)}
                  className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium hover:cursor-pointer"
                >
                  Zarejestruj się
                </button>
              </p>
              ...
              <p>
                ...
                <button
                  onClick={() => setIsLogin(true)}
                  className="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-medium hover:cursor-pointer"
                >
                  Zaloguj się
                </button>
              </p>
