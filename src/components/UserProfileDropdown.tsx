    ...
    <>
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center space-x-2 p-2 rounded-lg hover:bg-slate-100 transition-all duration-200"
        >
          {profile.avatar_url ? (
            <img
        ...
        {isOpen && (
          <div
            className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-xl border border-slate-200 z-50 overflow-hidden"
            ...
            <div className="p-4 bg-slate-50 border-b border-slate-200">
              <div className="grid grid-cols-3 gap-2 text-center">
                <div>
                  ...
                  <div className="text-xs text-slate-600">Poziom</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-600">Seria dni</div>
                </div>
              </div>
            </div>
